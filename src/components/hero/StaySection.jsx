                ...
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden mb-6 shadow-2xl shadow-obsidian/10 bg-gray-100">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    ...
                    <div className="flex items-center justify-between border-t border-white/20 pt-4">
                       <p className="text-lg font-black text-white">₹{stay.price.toLocaleString()}<span className="text-[10px] font-medium text-white/60 ml-1">/NIGHT</span></p>
                       <div className="flex items-center gap-3">
                          <div className="flex items-center gap-1 text-[8px] font-bold uppercase tracking-widest text-white/60">
                             <Users className="w-3 h-3" /> {stay.groupSize.split(' ')[0]}
                          </div>
                          <div className="flex items-center gap-1 text-[8px] font-bold uppercase tracking-widest text-white/60">
                             <Briefcase className="w-3 h-3" /> {stay.duration.split(' ')[0]}
                          </div>
                       </div>
                    </div>
                  </div>
