            ...
            <SwiperSlide key={i} className="h-full">
              <div className="relative w-full h-full">
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 text-white">
                  ...
                  <h3 className="text-2xl md:text-2xl font-black leading-none mb-2 drop-shadow-xl">{s.title}</h3>
      ...
      <div className="col-span-12 lg:col-span-4 grid grid-cols-2 grid-rows-2 gap-4 h-[500px]">
        {gridImages.slice(0, 4).map((img, i) =>
          i === 3 ? (
            ...
            <div key={i} className="relative group/node overflow-hidden rounded-lg shadow-lg shadow-sky-100/50 hover:shadow-2xl hover:shadow-sky-200/50 transition-all duration-500">
              <img
                src={img}
